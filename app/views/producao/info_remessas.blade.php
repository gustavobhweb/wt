...
@section('title') Remessa {{ $remessa }} @endsection

@section('content')

<div class='jtable'>
	<div data-section='header'>
		<a href='{{ URL::to("producao/expedicao/?page=" . $pageBack) }}' class='wm-btn'>Voltar</a>
	</div><!-- section="header" -->
	...
	<table>
		...
		<tbody>
			...
			<tr>
				<td style="width:45px"><img src='{{ URL::to("imagens/" . $solicitacao->usuario->matricula . "/" . $solicitacao->foto) }}' width='48' height='70'></td>
